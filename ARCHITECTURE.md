...
- **Line of Sight / Fog of War**:
  ...
  - `max_range` is **required** (no shared default): the runner and each program keep **separate** per-entity `@export var sight_range: int = 10` values (`CP2020Netrunner`, `BlackIce`, `CP2020NpcNetrunner`, `CP2020Datafort`) so future modifiers (deck/gear/program upgrades) can affect one side without touching the other.
